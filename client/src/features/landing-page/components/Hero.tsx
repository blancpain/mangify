...
const useStyles = createStyles((theme) => ({
  hero: {
    position: 'relative',
    // backgroundImage:
    //   'url(https://images.unsplash.com/photo-1555243896-c709bfa0b564?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2970&q=80)',
